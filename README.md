...
### 2026-06-24
- **镜牢统计报告**：完成镜牢后自动生成 Excel 统计报告（含摘要、详细记录、多种图表）
- **统计图表**：支持耗时柱状图、通行证经验趋势图、时间分布饼图、队伍对比图、难度对比图
- **应用内查看**：点击"查看统计"按钮可在应用内浏览图表（支持滚轮切换）
- **历史持久化**：镜牢记录保存至 `logs/mirror_history.json`，跨会话可查看

## 未来计划

- [x] 运行结束后统计获取的通行证等级和经验卡数量、纽数量
- [ ] 自适应窗口位置，可以不用左上角
- [x] 将运行期间的统计生成为excel文件或图表，提高可阅读性
- [ ] 完善代码函数注释文档
- [ ] 针对主题包配置提供GUI
- [ ] 持续修复BUG
- [ ] ……
